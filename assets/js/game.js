...
var shop = function () {
	...
	switch (shopOptionPrompt) {
		...
		case "leave": {
			...
			//d do nothing, so function will end
			break;
		}
		default: {
...
// functionto generate a random numeric value
...
var playerInfo = {
	...
	refillHealth: function () {
		if (this.money >= 7) {
			...
			window.alert("You don't have enough mooney!");
		}
	},
...
var enemyInfo = [
	...
	{ name: "Rombo Trumble", attack: randomNumber(10, 14) },
];
